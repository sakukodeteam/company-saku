 <!-- Content Header (Page header) -->
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('admin4739/'.$this->router->fetch_class());?>">Team</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                   <?php if($check == 'valid'): ?>
                                   <!-- form -->
                                   <form role="form" method="POST" id="form-team" action="<?php echo site_url('admin4739/team/save');?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-xs-12">
                                                ...
                                                <?php 
                                                    ...
                                                    echo '<p class="text-primary"><a href="'.site_url('admin4739/team/change-picture/'.$teamid).'" data-toggle="tooltip" data-placement="top" title="change picture">'.$picture.' </a></p>';
                                                    echo '</div>';
                                                endif; ?>
                                                <div class="form-group">
        ...
        success: function (data) {
            if(data.status == false){
                ...
                if(data.load == 0){
                    ...
                    var url = "<?php echo site_url('admin4739/team');?>";
